...
output_file = os.path.join(path_saida, f'dados_cams_{data_str}_12UTC.zip')
...
request = {
    "variable": [
        ...
        "relative_humidity"],
    "pressure_level": ["1000"],
    "date": ["2025-08-24/2025-08-24"],  # Modificado para formato simples
    "time": ["12:00"],
    "leadtime_hour": ["0"],
...
print(f"Baixando dados de {data_str} 12:00 UTC...")
try:
